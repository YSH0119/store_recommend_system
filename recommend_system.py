...
# 해시태그 목록
hashtag_list = [
    "가성비가 좋아요", "건강한 맛이에요", "고기 질이 좋아요", "기본 안주가 좋아요", "나물 반찬이 맛있어요",
    "단체모임 하기 좋아요", "대화하기 좋아요", "디저트가 맛있어요", "라이브공연이 훌륭해요", "룸이 잘 되어있어요",
    "매장이 넓어요", "매장이 청결해요", "메뉴 구성이 알차요", "반려동물과 가기 좋아요", "반찬이 잘 나와요",
    "뷰가 좋아요", "비싼 만큼 가치있어요", "사진이 잘 나와요", "샐러드바가 잘 되어있어요", "선물하기 좋아요",
    "소스가 맛있어요", "수프가 맛있어요", "숙성이 잘 되어있어요", "술이 다양해요", "스테이크가 맛있어요",
    "아늑해요", "아이와 가기 좋아요", "양이 많아요", "에스프레소가 진해요", "오래 머무르기 좋아요",
    "음료가 맛있어요", "음식이 맛있어요", "음식이 빨리 나와요", "음악이 좋아요", "인테리어가 멋져요",
    "자리 배치가 효율적이에요", "잡내가 적어요", "재료가 신선해요", "적당히 익혀줘요", "전통 한식에 가까워요",
    "정성이 담긴 요리예요", "조명이 화사해요", "주차하기 편해요", "직접 잘 구워줘요", "집중하기 좋아요",
    "차분한 분위기에요", "채소가 신선해요", "처음처럼 서비스가 좋아요", "초밥이 맛있어요", "친절해요",
    "커피가 맛있어요", "컨셉이 독특해요", "코스요리가 알차요", "특별한 날 가기 좋아요", "특별한 메뉴가 있어요",
    "파스타가 맛있어요", "파티하기 좋아요", "포장이 깔끔해요", "풍미가 깊어요", "한상차림이 맛있어요",
    "향신료가 강하지 않아요", "혼밥하기 좋아요", "혼술하기 좋아요", "환기가 잘 돼요", "화장실이 깨끗해요", "후식이 잘 나와요"
]
